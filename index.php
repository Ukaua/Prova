        ...
        <div class="card-body">
          ...
          <table id="senhaform">    
             ...
             <tr>
                ...
                <td class="limpar"><input type="button" name="limpar" class="num" value="Clear" onclick="Limpar()" /></td>
                <td class="Entrar"><input type="submit" name="num0" class="num" value="Login" onclick="Entrar()" /></td></td>
            </tr>
          </table>
       </fieldset>
       </center>
