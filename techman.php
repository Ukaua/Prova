...
<body>
    <div id="row1" class="row">
      ...
      <div class="col"></div>
      <div id="sair" class="col">
        <?php
        include 'conecta.php';
        $admin = mysqli_query($conn, "SELECT * FROM usuarios WHERE senha = $user and perfil = 2");
        $row = mysqli_num_rows($admin);
        if ($row > 0) {
          echo '<a class="novo" href="#" data-bs-toggle="modal" class="Equip" data-bs-target="#exampleModal">Novo Equipamento</a>';
        } else {
          "";
        }
        ?><a class="sair" href="sair.php"><img src="img_sis/logout_sair.png" width="35" height="35"></a> 
      </div>
    </div>
